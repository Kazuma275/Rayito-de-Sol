...
$lang_file = "./backend/lang/{$lang}.php";
    ...
    <div class="container">
        ...
        <section id="amenities" class="intro-section">
            <div class="container">
                ...
                <div class="services-container">
                    <?php require_once "./backend/controllers/amenities.php"; ?>
                </div>
            </div>
        </section>
        ...
        <section id="reviews" class="reviews-section">
            ...
            <div class="reviews-container">
                <?php require_once "./backend/controllers/reviews.php"; ?>
            </div>
        </section>
        ...
        <section id="ubication">
            ...
            <div class="iframe-container">
                <?php require_once './backend/controllers/ubication.php'; ?>
            </div>
        </section>
