        ...
        <nav>
            <div class="topnav" id="myTopnav">
                ...
                <!-- Mostrar el enlace de reservas solo si la sesión está activa -->
                    ...
                    <a href="<?php echo __DIR__ . "/../../functions/information.php"; ?>" class="login-message"><?php echo "Hey," . $_SESSION['username']?></a>
                ...
                <div class="settings-container" style="position: relative;">
                    ...
                    <img id="current-flag" 
                        src="/img/idiomas/<?php echo isset($_SESSION['lang']) && $_SESSION['lang'] !== '' ? $_SESSION['lang'] : 'es'; ?>.png" 
                        alt="<?php echo isset($lang['current_lang']) ? $lang['current_lang'] : 'Español'; ?>" 
                        class="flag">
